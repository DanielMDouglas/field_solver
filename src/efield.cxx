...
int main(int argc, char const * argv[])
{
  ...
  field <double> potential (inFileName);

  field <double> Ex (potential.x_space,
		     potential.y_space,
		     potential.z_space,
		     0);
  field <double> Ey (potential.x_space,
		     potential.y_space,
		     potential.z_space,
		     0);
  field <double> Ez (potential.x_space,
		     potential.y_space,
		     potential.z_space,
		     0);
  field <double> Emag (potential.x_space,
		       potential.y_space,
		       potential.z_space,
		       0);
