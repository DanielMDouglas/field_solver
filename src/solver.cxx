...
void solve_field(boundary b)
{
  ...
  field <double> a0 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a1 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a2 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a3 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a4 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a5 (x_axis, y_axis, z_axis, constant(0.));
  field <double> a6 (x_axis, y_axis, z_axis, constant(0.));
