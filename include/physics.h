...
std::vector <double> E(std::vector <double>, scalarField <double>*);
std::vector <double> driftV(std::vector <double>, double);

/* path drift_path(std::vector <double>, scalarField*, boundary); */
void drift_path(std::vector <double>, scalarField <double>*, boundary, path*&);
std::vector <double> ramo_induction(double, path *, scalarField <double>*);
